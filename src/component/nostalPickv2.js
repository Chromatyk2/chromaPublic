...
function NostalPickV2(props) {
    ...
    useEffect(() => {
        var consoles = ["GB","GBA","GBC","MEGADRIVE","N64","NDS","NGC","PS1","PSP","SNES","NES","MASTER SYSTEM","GAMEGEAR","PS2"];
    ...
    return(
        <>
            <div style={{marginTop:"300px"}} id={"boxContainerId"} className="boxContainer">
                    {randomConsoles &&
                        <>
