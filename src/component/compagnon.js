                ...
                <div style={{position: "relative", marginTop: "-40px"}}>
                    {compagnon ?
                        ...
                        <>
                            ...
                            <div style={{display:"flex", justifyContent:"center",gap:"5px"}}><img style={{margin: 0, height: "20px", width: "20px"}} src={"/images/berry.png"}/><span style={{fontSize:"15px"}}>{"x" + profil.berry}</span</div>
