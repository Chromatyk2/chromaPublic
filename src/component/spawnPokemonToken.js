                                                        ...
                                                        (result) => {
                                                            ...
                                                            switch (isShiny){
                                                                case 1 :
                                                                    ...
                                                                    Axios.post('/api/capture', {pseudo: pseudo, pkmName: name, pkmImage:result.sprites.front_shiny,pkmId:finalId, shiny:1, dateCapture:moment(new Date()).utc().format('YYYY-MM-DD hh:mm:ss')})
