                                                    ...
                                                    <>
                                                        <button stade={stadeC} style={customStyles.buttonMyCard} className={"cardBox"}>
                                                            ...
                                                            <button cardId={val.card} myCardNb={val.nbCard}
                                                                    rarity={stadeB == -1 ? "undefined" ? "unknowned" : items.data.find((myCard) => myCard.id === val.card).rarity} className={"unsellButton"} id={"unsellButton"+val.card} onClick={unsellCard}>-</button>
