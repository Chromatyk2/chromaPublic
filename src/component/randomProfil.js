                    ...
                    <div style={{
                        ...
                        <div className={"profilVisualsList"}>
                            <div
                                ...
                                value={"first_pokemon"}
                                className={compagnonList && compagnonList.find((item)=>item.pokemon == allProfil[randomIndex].fifth_pokemon.match(/\d/g).join("") && item.level == 100) ? "anchorTooltip uniquePokemonContainerTeam maxLevelFrame" : "anchorTooltip uniquePokemonContainerTeam"}>
                            ...
                            <div
                                ...
                                className={compagnonList && compagnonList.find((item)=>item.pokemon == allProfil[randomIndex].second_pokemon.match(/\d/g).join("") && item.level == 100) ? "anchorTooltip uniquePokemonContainerTeam maxLevelFrame" : "anchorTooltip uniquePokemonContainerTeam"}>
                            </div>
                            <div
                                style={{backgroundImage: allProfil[randomIndex].third_pokemon ? 'url(' + allProfil[randomIndex].third_pokemon + ')' : 'url(/images/random.png)'}}
                                value={"third_pokemon"}
                                className={compagnonList && compagnonList.find((item)=>item.pokemon == allProfil[randomIndex].third_pokemon.match(/\d/g).join("") && item.level == 100) ? "anchorTooltip uniquePokemonContainerTeam maxLevelFrame" : "anchorTooltip uniquePokemonContainerTeam"}>
                            </div>
                            ...
                            <div
                                ...
                                className={compagnonList && compagnonList.find((item)=>item.pokemon == allProfil[randomIndex].fourth_pokemon.match(/\d/g).join("") && item.level == 100) ? "anchorTooltip uniquePokemonContainerTeam maxLevelFrame" : "anchorTooltip uniquePokemonContainerTeam"}>
                            </div>
                            <div
                            ...
                            <div
                                ...
                                value={"sixth_pokemon"}
                                className={compagnonList && compagnonList.find((item)=>item.pokemon == allProfil[randomIndex].sixth_pokemon.match(/\d/g).join("") && item.level == 100) ? "anchorTooltip uniquePokemonContainerTeam maxLevelFrame" : "anchorTooltip uniquePokemonContainerTeam"}>
                            </div>
                        </div>
                    </div>
            }
