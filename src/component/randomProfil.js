            ...
            {randomIndex > -1 &&
                    <div style={{
                        ...
                        <div className={"profilVisualsList"}>
                            <div
                                style={{filter : allProfil[randomIndex].firstNeg === 1 ?  "invert(1)" : "invert(0)",backgroundImage: allProfil[randomIndex].first_pokemon ? 'url(' + allProfil[randomIndex].first_pokemon + ')' : 'url(/images/random.png)'}}
                                value={"first_pokemon"}
                            ...
                            <div
                                style={{filter : allProfil[randomIndex].secondNeg === 1 ?  "invert(1)" : "invert(0)",backgroundImage: allProfil[randomIndex].second_pokemon ? 'url(' + allProfil[randomIndex].second_pokemon + ')' : 'url(/images/random.png)'}}
                            ...
                            <div
                                style={{filter : allProfil[randomIndex].thirdNeg === 1 ?  "invert(1)" : "invert(0)",backgroundImage: allProfil[randomIndex].third_pokemon ? 'url(' + allProfil[randomIndex].third_pokemon + ')' : 'url(/images/random.png)'}}
                                value={"third_pokemon"}
                            ...
                            <div
                                style={{filter : allProfil[randomIndex].fourthNeg === 1 ?  "invert(1)" : "invert(0)",backgroundImage: allProfil[randomIndex].fourth_pokemon ? 'url(' + allProfil[randomIndex].fourth_pokemon + ')' : 'url(/images/random.png)'}}
                            ...
                            <div
                                style={{filter : allProfil[randomIndex].fiveNeg === 1 ?  "invert(1)" : "invert(0)",backgroundImage: allProfil[randomIndex].fifth_pokemon ? 'url(' + allProfil[randomIndex].fifth_pokemon + ')' : 'url(/images/random.png)'}}
                                value={"fifth_pokemon"}
                            ...
                            <div
                                style={{filter : allProfil[randomIndex].sixthNeg === 1 ?  "invert(1)" : "invert(0)",backgroundImage: allProfil[randomIndex].sixth_pokemon ? 'url(' + allProfil[randomIndex].sixth_pokemon + ')' : 'url(/images/random.png)'}}
                                value={"sixth_pokemon"}
