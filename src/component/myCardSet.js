                                ...
                                if (myCardsId.includes(val.id)) {
                                        ...
                                        <div onClick={openModal} style={{animation: "glowGetRainbow 10s infinite alternate"}} id={"lastBangerContainer"} className={"lastBangerContainer"}>
                                            <div cardId={val.id} pokemonId={val.dexId} myCardNb={cardNb.nbCard} image={val.image} stade={stadeC} className="cardBangerAlertSet">
                                                <LazyLoadImage
                                                    ...
                                                    src={rarities[0].block == "gym" ? "https://assets.tcgdex.net/en/"+rarities[0].block+"/"+props.idBooster+"/"+val.localId+"/high.png" : "https://assets.tcgdex.net/fr/"+rarities[0].block+"/"+props.idBooster+"/"+val.localId+"/high.png"}/>
                                            ...
                                            <div cardId={val.id} pokemonId={val.dexId} myCardNb={cardNb.nbCard} image={val.image} stade={stadeC} onClick={openModal} style={{filter: "drop-shadow(rgb(200, 185, 19) 0px 0px 5px) drop-shadow(rgb(200, 185, 19) 0px 0px 5px) drop-shadow(rgb(200, 185, 19) 0px 0px 5px)"}} id={"lastBangerContainer"} className={"lastBangerContainer"}>
                                                <div cardId={val.id} pokemonId={val.dexId} myCardNb={cardNb.nbCard} image={val.image} stade={stadeC} className="cardBangerAlertSetThree">
                                                    <LazyLoadImage
                                                        ...
                                                        src={rarities[0].block == "gym" ? "https://assets.tcgdex.net/en/"+rarities[0].block+"/"+props.idBooster+"/"+val.localId+"/high.png" : "https://assets.tcgdex.net/fr/"+rarities[0].block+"/"+props.idBooster+"/"+val.localId+"/high.png"}/>                                                    {/*<img className={"shadowBangerCard"} style={{width:"250px",filter:"brightness(1.2)"}} src={"https://images.pokemontcg.io/"+val.set.id+"/"+val.number+"_hires.png"}/>*/}
                                                </div>
                                            </div>
                                        )
                                    }else{
                                        return (
                                            <button stade={stadeC} style={customStyles.buttonMyCard} onClick={openModal} className={"cardBox"}>
                                                <LazyLoadImage
                                                    ...
                                                    src={rarities[0].block == "gym" ? "https://assets.tcgdex.net/en/"+rarities[0].block+"/"+props.idBooster+"/"+val.localId+"/high.png" : "https://assets.tcgdex.net/fr/"+rarities[0].block+"/"+props.idBooster+"/"+val.localId+"/high.png"}/>                                                {/*<img stade={stadeC} style={{filter:stadeC == 1 ? "drop-shadow(rgb(17, 208, 154) 0px 0px 5px) drop-shadow(rgb(17, 210, 154) 0px 0px 5px) drop-shadow(rgb(17, 208, 154) 0px 0px 5px)" : stadeC == 2 ? "drop-shadow(rgb(14, 208, 214) 0px 0px 3px) drop-shadow(rgb(14, 208, 214) 0px 0px 5px) drop-shadow(rgb(14, 208, 214) 0px 0px 5px)" : stadeC == 3 && "drop-shadow(rgb(200, 185, 19) 0px 0px 5px) drop-shadow(rgb(200, 185, 19) 0px 0px 5px) drop-shadow(rgb(200, 185, 19) 0px 0px 5px)"}} cardId={val.id} pokemonId={val.dexId} myCardNb={cardNb.nbCard}*/}
                                    ...
                                    return (
                                        <LazyLoadImage
                                            ...
                                            src={rarities[0].block == "gym" ? "https://assets.tcgdex.net/en/"+rarities[0].block+"/"+props.idBooster+"/"+val.localId+"/high.png" : "https://assets.tcgdex.net/fr/"+rarities[0].block+"/"+props.idBooster+"/"+val.localId+"/high.png"}/>                                        // <img style={{filter:"grayscale(1)"}} className={"fit-picture-card"} src={"https://images.pokemontcg.io/"+val.set.id+"/"+val.number+".png"} onError={errorImage}/>
                                    )
                                }
                            })
                        }
