                                    ...
                                    if(stadeC == 4){
                                        return (
                                            <div style={{position:"relative", animation: "glowGetRainbow 10s infinite alternate"}}
                                                ...
                                                {myCards.find((uc) => uc.card == val.id).nbCard > 1 && <div className="infoNbCapture" style={{zIndex:"1",width:"30px",height:"30px",lineHeight:"30px",left:0}}>X{myCards.find((uc) => uc.card == val.id).nbCard}</div>}
                                        ...
                                        return (
                                            <div cardId={val.id} pokemonId={val.dexId} myCardNb={cardNb.nbCard}
                                                ...
                                                {myCards.find((uc) => uc.card == val.id).nbCard > 1 && <div
                                                    className="infoNbCapture" style={{zIndex:"1",width:"30px",height:"30px",lineHeight:"30px",left:0}}>X{myCards.find((uc) => uc.card == val.id).nbCard}</div>}
                                                <div cardId={val.id} pokemonId={val.dexId} myCardNb={cardNb.nbCard}
                                                     image={val.image} stade={stadeC}
