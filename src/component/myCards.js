                    ...
                    :
                        nbCards &&
                            totalCard &&
                                ...
                                return(
                                    <MyUniqueBooster page={val.booster} change = {displayPage} nbCard={val} boosterList={boosterList} maxBooster={typeof boosterList.find((uc) => uc.name == val.booster) === "undefined" ? boosterList.find((uc) => uc.guruName == val.booster).totalCards : boosterList.find((uc) => uc.name == val.booster).totalCards}/>
                                )
                            })
                }
            </div>
