                    ...
                    :
                        nbCards &&
                            totalCard &&
                                ...
                                return(
                                    <MyUniqueBooster page={val.booster} change = {displayPage} nbCard={val.booster} boosterList={boosterList} maxBooster={boosterList.find((uc) => uc.name == val.booster).totalCards}/>
                                )
                            })
                }
            </div>
