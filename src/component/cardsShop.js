                    ...
                    {points > 499 ?
                        loading === false ?
                            <>
                                ...
                                <input className={"nbToBuy"} id={"nbBoosterToBuyRandom"} type="number" placeholder={"1"} min="1" max={Math.floor(points/500)} value={"1"} />
                            </>
                            :
                            ...
                            {points > 999 ?
                                loading === false ?
                                    <>
                                        ...
                                        <input className={"nbToBuy"} id={"nbBoosterToBuy"+val.name} type="number" placeholder={"1"} min="1" max={Math.floor(points/1000)} value={"1"} />
                                    </>
                                    :
                                    <button className="guessTradeButton">Chargement</button>
                                :
